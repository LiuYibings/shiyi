...
package com.example.supplements.map;
...
import com.example.supplements.beans.RegionDetailResult;
import com.example.supplements.beans.RouteResult;
...
public class MapDataHelper {
    ...
    private void getRegionDetail(TextField startLocationText) {
        ...
        LogUtil.info("nihao",url);
        HttpUtils.getInstance(context).get(url, result -> {
//            Gson gson=new Gson();
//            RegionDetailResult regionDetailResult = gson.fromJson(result, RegionDetailResult.class);
