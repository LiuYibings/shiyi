...
public class IndexImgPageSliderProvider extends PageSliderProvider {
    private List<IndexImg> list;
    private AbilitySlice abilitySlice;

    public IndexImgPageSliderProvider(List<IndexImg> list, AbilitySlice abilitySlice) {
        this.list = list;
...
//        获取轮廓图数据:此对象中存储的是图片的网络地址
        IndexImg indexImg = list.get(i);
        String netImgUrl= "http://162.14.74.164:8888/image/"+indexImg.getId();   //http://162.14.74.164:8888/image/1
