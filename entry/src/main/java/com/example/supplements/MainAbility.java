...
import com.example.supplements.widget.controller.FormControllerManager;
...
public class MainAbility extends Ability {
    ...
    public void onStart(Intent intent) {
        ...
        super.setMainRoute(frontOneSlice.class.getName());
    ...
    protected ProviderFormInfo onCreateForm(Intent intent) {
        ...
        HiLog.info(TAG, "sdfsdf");
        componentProvider.setString(ResourceTable.Id_title, "setText", "sldf");
